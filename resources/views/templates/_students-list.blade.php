...
<div class="p-4 w-[35rem]  rounded overflow-hidden justify-between shadow-md bg-white mt-3">

    <h3 class='text-2xl h-[2rem]'>{{$student->first_name}} {{$student->last_name}}</h3>
    <p class='text-lg h-[2rem]'>{{$student->birth_date}}</p> 
    <p class='text-lg h-[4rem]'>{{$student->address}}</p> 
...
<div id="first_name_error" hx-swap-oob="true" >
</div> 

<div id="last_name_error" hx-swap-oob="true" >
</div> 
